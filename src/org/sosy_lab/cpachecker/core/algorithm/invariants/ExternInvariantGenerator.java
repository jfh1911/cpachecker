...
public class ExternInvariantGenerator extends AbstractInvariantGenerator implements StatisticsProvider {
  ...
  /**
   * Creates a new {@link ExternInvariantGenerator}.
   *
   ...
   *
   * @return a new {@link ExternInvariantGenerator}.
   *
  ...
  public static InvariantGenerator create(
    ...
    return new ExternInvariantGenerator(
            pConfig,
  ...
  private ExternInvariantGenerator(
  ...
  private ExternInvariantGenerator(final Configuration config,
      final LogManager pLogger,
      final ShutdownManager pShutdownManager,
      Optional<ShutdownManager> pShutdownOnSafeManager,
      final int pIteration,
