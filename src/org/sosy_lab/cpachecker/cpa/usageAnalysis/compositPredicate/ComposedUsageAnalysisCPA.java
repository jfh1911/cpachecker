...
public class ComposedUsageAnalysisCPA extends AbstractCPA implements ConfigurableProgramAnalysis {
   ...
   */
  private ComposedUsageAnalysisCPA(
    ...
    super(
        "join",
        "sep",
        DelegateAbstractDomain.<ComposedUsagePredicateAnalysisState>getInstance(),
        null);
    config.inject(this);
  ...
  public AbstractState getInitialState(CFANode pNode, StateSpacePartition pPartition)
    ...
    return new ComposedUsagePredicateAnalysisState();
  }
