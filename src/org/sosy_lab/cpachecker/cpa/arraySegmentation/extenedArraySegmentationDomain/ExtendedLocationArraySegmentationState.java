...
public class ExtendedLocationArraySegmentationState<T extends ExtendedCompletLatticeAbstractState<T>>
    implements Serializable, LatticeAbstractState<ExtendedLocationArraySegmentationState<T>>, AbstractState,
    Graphable,
  ...
  public ExtendedLocationArraySegmentationState(
  ...
  @Override
  public ExtendedLocationArraySegmentationState<T> join(ExtendedLocationArraySegmentationState<T> pOther)
    ...
    if (pOther.equals(this)) {
      ...
      ExtendedLocationArraySegmentationState<T> returnElement;
      String mergeLogInfo =
      ...
      if (joinSegmentation.equals(pOther.getArraySegmentation())) {
        ...
        returnElement =
            new ExtendedLocationArraySegmentationState<>(this.location, joinSegmentation, this.logger);
      }
  ...
  @Override
  public boolean isLessOrEqual(ExtendedLocationArraySegmentationState<T> pOther)
      throws CPAException, InterruptedException {
  ...
  @Override
  public ExtendedLocationArraySegmentationState<T> clone() {
    return new ExtendedLocationArraySegmentationState<>(this.location, this.arraySegmentation.clone(), logger);
  }
  ...
  public boolean equals(Object obj) {
    ...
    ExtendedLocationArraySegmentationState other = (ExtendedLocationArraySegmentationState) obj;
