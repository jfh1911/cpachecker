...
public class EnhancedCExpressionSimplificationVisitor extends ExpressionSimplificationVisitor {
   ...
   * @param exprLHS continaign a non neasted binary expression, where the right hand side needs to
   *        be a integer literal
   * @return either null, if the experssion cannot be simplified or a simplified term
   */
  private CExpression
